 ...
 * @author RUCHI
 */
public class CandidateRegisterationDisplay {
     String output="";
...
output+="    <form id=\"login-form\" class=\"form\" action=\"CandidateRegisteration\" method=\"post\" style=\"width:80%\">\n" +
"                    <div class=\"form-group\">\n" +
"                                <label for=\"username\" class=\"text-info\">Name:</label><br>\n" +
"                                <input type=\"text\" placeholder=\"Enter UserName\" name=\"name\" value=\""+name+"\" id=\"id\"  class=\"form-control\" required>\n" +
"                            </div>\n" +
"                        <div class=\"form-group\">\n" +
